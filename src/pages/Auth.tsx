            ...
            <main className="relative z-10 w-full max-w-md px-6">
                <div className="glass-card rounded-2xl p-8 sm:p-12 text-center flex flex-col items-center">
                    ...
                    <div className="w-full space-y-6">
                        <button
                            className="group cursor-pointer relative w-full flex items-center justify-center gap-3 bg-white text-gray-900 hover:bg-gray-50 focus:ring-4 focus:ring-primary/30 transition-all duration-200 py-3.5 px-4 rounded-xl font-medium text-base shadow-sm">
                            ...
                            <div
                                className="absolute inset-0 rounded-xl bg-white/10 opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none"></div>
                        </button>
